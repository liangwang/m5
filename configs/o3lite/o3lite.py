...
system = System(cpu = [DerivO3CPU(cpu_id = i,
    ...
    renameWidth = options.renameWidth,
    dispatchWidth = options.dispatchWidth,
    issueWidth = options.issueWidth,
    wbWidth = options.wbWidth,
    commitWidth = options.commitWidth,
    squashWidth = options.squashWidth) for i in xrange(options.num_cpus)],
