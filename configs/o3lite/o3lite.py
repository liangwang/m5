...
system = System(cpu = [DerivO3liteCPU(cpu_id = i,
    ...
    LQEntries = options.numROBEntries,
    SQEntries = options.numROBEntries,
    SBEntries = options.SBEntries,
    numSubscribers = options.numSubscribers,
    fetchWidth = options.pipeWidth,
    decodeWidth = options.pipeWidth,
    renameWidth = options.pipeWidth,
    dispatchWidth = options.pipeWidth,
    issueWidth = options.pipeWidth,
    wbWidth = options.pipeWidth,
    commitWidth = options.pipeWidth,
    squashWidth = options.pipeWidth) for i in xrange(options.num_cpus)],
